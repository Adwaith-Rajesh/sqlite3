...
static int fts5ConfigParseColumn(
    ...
    char **pzErr) {
    int rc = SQLITE_OK;
    if (0 == sqlite3_stricmp(zCol, FTS5_RANK_NAME) || 0 == sqlite3_stricmp(zCol, FTS5_ROWID_NAME)) {
...
int sqlite3Fts5ConfigParse(
    ...
    *ppOut = pRet = (Fts5Config *)sqlite3_malloc(sizeof(Fts5Config));
    ...
    if (rc == SQLITE_OK && pRet->bContentlessDelete && pRet->eContent != FTS5_CONTENT_NONE) {
        *pzErr = sqlite3_mprintf(
    ...
    ** tokenizer (unicode61) now.  */
    ...
    if (rc == SQLITE_OK && pRet->zContent == 0) {
        const char *zTail = 0;
        assert(pRet->eContent == FTS5_CONTENT_NORMAL || pRet->eContent == FTS5_CONTENT_NONE);
...
int sqlite3Fts5ConfigLoad(Fts5Config *pConfig, int iCookie) {
    ...
    if (rc == SQLITE_OK && iVersion != FTS5_CURRENT_VERSION && iVersion != FTS5_CURRENT_VERSION_SECUREDELETE) {
        rc = SQLITE_ERROR;
        if (pConfig->pzErrmsg) {
