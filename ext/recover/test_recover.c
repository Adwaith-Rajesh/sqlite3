...
static int testRecoverCmd(
    ...
    switch (iSub) {
        case 0:
            assert(sqlite3_stricmp("config", aSub[iSub].zSub) == 0);
            {
                const char *aOp[] = {
                    "testdb",          /* 0 */
                    "lostandfound",    /* 1 */
        ...
        case 1:
            assert(sqlite3_stricmp("run", aSub[iSub].zSub) == 0);
            {
        ...
        case 2:
            assert(sqlite3_stricmp("errmsg", aSub[iSub].zSub) == 0);
            {
        ...
        case 3:
            assert(sqlite3_stricmp("errcode", aSub[iSub].zSub) == 0);
            {
        ...
        case 4:
            assert(sqlite3_stricmp("finish", aSub[iSub].zSub) == 0);
            {
        ...
        case 5:
            assert(sqlite3_stricmp("step", aSub[iSub].zSub) == 0);
            {
...
#endif
int
sqlite3_dbdata_init(sqlite3 *, char **, const sqlite3_api_routines *);
