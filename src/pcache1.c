...
static int pcache1Init(void *NotUsed) {
    ...
    */
    ...
    pcache1.separateCache =
        sqlite3GlobalConfig.pPage == 0 || sqlite3GlobalConfig.bCoreMutex > 0;
#else
...
*/
static SQLITE_NOINLINE PgHdr1 *
pcache1FetchStage2(PCache1 *pCache, unsigned int iKey, int createFlag) {
...
*/
static PgHdr1 *pcache1FetchNoMutex(sqlite3_pcache *p, unsigned int iKey,
                                   int createFlag) {
    PCache1 *pCache = (PCache1 *)p;
    PgHdr1 *pPage = 0;
...
*/
static void pcache1Unpin(sqlite3_pcache *p, sqlite3_pcache_page *pPg,
                         int reuseUnlikely) {
    PCache1 *pCache = (PCache1 *)p;
...
*/
static void pcache1Rekey(sqlite3_pcache *p, sqlite3_pcache_page *pPg,
...
int sqlite3PcacheReleaseMemory(int nReq) {
    ...
    if (sqlite3GlobalConfig.pPage == 0) {
        ...
        while ((nReq < 0 || nFree < nReq) && (p = pcache1.grp.lru.pLruPrev) != 0 &&
               p->isAnchor == 0) {
