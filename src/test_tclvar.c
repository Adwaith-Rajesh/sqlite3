...
static int tclvarConnect(sqlite3 *db, void *pAux, int argc,
...
static int tclvarFilter(sqlite3_vtab_cursor *pVtabCursor, int idxNum,
...
*/
static int tclvarUpdate(sqlite3_vtab *tab, int argc, sqlite3_value **argv,
                        sqlite_int64 *pRowid) {
    tclvar_vtab *pTab = (tclvar_vtab *)tab;
    if (argc == 1) {
