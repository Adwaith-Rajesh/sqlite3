...
static void set_options(Tcl_Interp *interp) {
    ...
    Tcl_SetVar2(interp, "sqlite_options", "allow_rowid_in_view", "1",
                TCL_GLOBAL_ONLY);
#else
    Tcl_SetVar2(interp, "sqlite_options", "allow_rowid_in_view", "0",
                TCL_GLOBAL_ONLY);
#endif

#ifdef SQLITE_CASE_SENSITIVE_LIKE
    Tcl_SetVar2(interp, "sqlite_options", "casesensitivelike", "1",
                TCL_GLOBAL_ONLY);
#else
    Tcl_SetVar2(interp, "sqlite_options", "casesensitivelike", "0",
                TCL_GLOBAL_ONLY);
#endif
...
#else
    Tcl_SetVar2(interp, "sqlite_options", "default_ckptfullfsync", "0",
                TCL_GLOBAL_ONLY);
#endif
    ...
    Tcl_SetVar2(interp, "sqlite_options", "pagecache_overflow_stats", "0",
                TCL_GLOBAL_ONLY);
#else
    Tcl_SetVar2(interp, "sqlite_options", "pagecache_overflow_stats", "1",
                TCL_GLOBAL_ONLY);
#endif
    ...
    Tcl_SetVar2(interp, "sqlite_options", "offset_sql_func", "1",
                TCL_GLOBAL_ONLY);
#else
    Tcl_SetVar2(interp, "sqlite_options", "offset_sql_func", "0",
                TCL_GLOBAL_ONLY);
#endif
    ...
    Tcl_SetVar2(interp, "sqlite_options", "like_match_blobs", "0",
                TCL_GLOBAL_ONLY);
#else
    Tcl_SetVar2(interp, "sqlite_options", "like_match_blobs", "1",
                TCL_GLOBAL_ONLY);
#endif
    ...
    Tcl_SetVar2(interp, "sqlite_options", "default_autovacuum", "0",
                TCL_GLOBAL_ONLY);
#else
    ...
    Tcl_SetVar2(interp, "sqlite_options", "compileoption_diags", "0",
                TCL_GLOBAL_ONLY);
#else
    Tcl_SetVar2(interp, "sqlite_options", "compileoption_diags", "1",
                TCL_GLOBAL_ONLY);
#endif
...
#define SQLITE_ENABLE_LOCKING_STYLE 0
    ...
    Tcl_SetVar2(interp, "sqlite_options", "lock_proxy_pragmas", "1",
                TCL_GLOBAL_ONLY);
#else
    Tcl_SetVar2(interp, "sqlite_options", "lock_proxy_pragmas", "0",
                TCL_GLOBAL_ONLY);
#endif
#if defined(SQLITE_PREFER_PROXY_LOCKING) && defined(__APPLE__)
    Tcl_SetVar2(interp, "sqlite_options", "prefer_proxy_locking", "1",
                TCL_GLOBAL_ONLY);
#else
    Tcl_SetVar2(interp, "sqlite_options", "prefer_proxy_locking", "0",
                TCL_GLOBAL_ONLY);
#endif
    ...
    Tcl_SetVar2(interp, "sqlite_options", "update_delete_limit", "1",
                TCL_GLOBAL_ONLY);
#else
    Tcl_SetVar2(interp, "sqlite_options", "update_delete_limit", "0",
                TCL_GLOBAL_ONLY);
#endif
    ...
    Tcl_SetVar2(interp, "sqlite_options", "fast_secure_delete", "1",
                TCL_GLOBAL_ONLY);
#else
    Tcl_SetVar2(interp, "sqlite_options", "fast_secure_delete", "0",
                TCL_GLOBAL_ONLY);
#endif
    ...
    Tcl_SetVar2(interp, "sqlite_options", "multiplex_ext_overwrite", "1",
                TCL_GLOBAL_ONLY);
#else
    Tcl_SetVar2(interp, "sqlite_options", "multiplex_ext_overwrite", "0",
                TCL_GLOBAL_ONLY);
#endif

#ifdef YYTRACKMAXSTACKDEPTH
    Tcl_SetVar2(interp, "sqlite_options", "yytrackmaxstackdepth", "1",
                TCL_GLOBAL_ONLY);
#else
    Tcl_SetVar2(interp, "sqlite_options", "yytrackmaxstackdepth", "0",
                TCL_GLOBAL_ONLY);
#endif
