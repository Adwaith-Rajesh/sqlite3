...
static int devsymWrite(sqlite3_file *, const void *, int iAmt,
                       sqlite3_int64 iOfst);
...
static int devsymFullPathname(sqlite3_vfs *, const char *zName, int,
                              char *zOut);
...
*/
static int devsymRead(sqlite3_file *pFile, void *zBuf, int iAmt,
                      sqlite_int64 iOfst) {
    devsym_file *p = (devsym_file *)pFile;
...
*/
static int devsymWrite(sqlite3_file *pFile, const void *zBuf, int iAmt,
                       sqlite_int64 iOfst) {
    devsym_file *p = (devsym_file *)pFile;
...
*/
static int devsymSectorSize(sqlite3_file *pFile) { return g.iSectorSize; }
...
static int devsymShmMap(sqlite3_file *pFile, int iRegion, int szRegion,
...
*/
static int devsymOpen(sqlite3_vfs *pVfs, const char *zName, sqlite3_file *pFile,
...
*/
static int devsymFullPathname(sqlite3_vfs *pVfs, const char *zPath, int nOut,
                              char *zOut) {
...
*/
static int writecrashWrite(sqlite3_file *pFile, const void *zBuf, int iAmt,
                           sqlite_int64 iOfst) {
    devsym_file *p = (devsym_file *)pFile;
    if (g.nWriteCrash > 0) {
        g.nWriteCrash--;
...
*/
static int writecrashOpen(sqlite3_vfs *pVfs, const char *zName,
