...
*/
static void sqrFunc(sqlite3_context *context, int argc, sqlite3_value **argv) {
...
*/
static int sqr_init(sqlite3 *db, char **pzErrMsg,
...
*/
static void cubeFunc(sqlite3_context *context, int argc, sqlite3_value **argv) {
    double r = sqlite3_value_double(argv[0]);
...
*/
static int cube_init(sqlite3 *db, char **pzErrMsg,
                     const sqlite3_api_routines *pApi) {
    SQLITE_EXTENSION_INIT2(pApi);
...
*/
static int broken_init(sqlite3 *db, char **pzErrMsg,
                       const sqlite3_api_routines *pApi) {
    char *zErr;
    SQLITE_EXTENSION_INIT2(pApi);
...
*/
static int SQLITE_TCLAPI autoExtSqrObjCmd(void *clientData, Tcl_Interp *interp,
...
*/
static int SQLITE_TCLAPI cancelAutoExtSqrObjCmd(void *clientData,
...
*/
static int SQLITE_TCLAPI autoExtCubeObjCmd(void *clientData, Tcl_Interp *interp,
                                           int objc, Tcl_Obj *CONST objv[]) {
...
*/
static int SQLITE_TCLAPI cancelAutoExtCubeObjCmd(void *clientData,
                                                 Tcl_Interp *interp, int objc,
                                                 Tcl_Obj *CONST objv[]) {
...
*/
static int SQLITE_TCLAPI autoExtBrokenObjCmd(void *clientData,
                                             Tcl_Interp *interp, int objc,
                                             Tcl_Obj *CONST objv[]) {
...
*/
static int SQLITE_TCLAPI cancelAutoExtBrokenObjCmd(void *clientData,
                                                   Tcl_Interp *interp, int objc,
                                                   Tcl_Obj *CONST objv[]) {
...
*/
static int SQLITE_TCLAPI resetAutoExtObjCmd(void *clientData,
                                            Tcl_Interp *interp, int objc,
                                            Tcl_Obj *CONST objv[]) {
...
#ifndef SQLITE_OMIT_LOAD_EXTENSION
    Tcl_CreateObjCommand(interp, "sqlite3_auto_extension_sqr", autoExtSqrObjCmd,
                         0, 0);
    Tcl_CreateObjCommand(interp, "sqlite3_auto_extension_cube", autoExtCubeObjCmd,
                         0, 0);
