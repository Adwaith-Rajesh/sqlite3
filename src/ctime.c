...
static const char *const sqlite3azCompileOpt[] = {
    ...
    "COMPILER=clang-" CTIMEOPT_VAL(__clang_major__) "." CTIMEOPT_VAL(
    ...
    "DEFAULT_JOURNAL_SIZE_LIMIT=" CTIMEOPT_VAL(
    ...
    "DEFAULT_PROXYDIR_PERMISSIONS=" CTIMEOPT_VAL(
    ...
    "DEFAULT_WAL_AUTOCHECKPOINT=" CTIMEOPT_VAL(
...
#endif
#if (!defined(SQLITE_WIN32_MALLOC) && !defined(SQLITE_ZERO_MALLOC) && \
