...
static void test_destructor(sqlite3_context *pCtx, int nArg,
                            sqlite3_value **argv) {
    char *zVal;
    int len;
...
static void test_destructor16(sqlite3_context *pCtx, int nArg,
                              sqlite3_value **argv) {
    char *zVal;
    int len;
...
#endif
static void test_agg_errmsg16_step(sqlite3_context *a, int b,
                                   sqlite3_value **c) {}
...
static void test_auxdata(sqlite3_context *pCtx, int nArg,
                         sqlite3_value **argv) {
    int i;
...
*/
static void test_error(sqlite3_context *pCtx, int nArg, sqlite3_value **argv) {
...
*/
static void
counterFunc(sqlite3_context *pCtx, /* Function context */
...
*/
static void test_isolation(sqlite3_context *pCtx, int nArg,
                           sqlite3_value **argv) {
#ifndef SQLITE_OMIT_UTF16
...
*/
static void test_eval(sqlite3_context *pCtx, int nArg, sqlite3_value **argv) {
    sqlite3_stmt *pStmt;
    int rc;
...
*/
#ifndef SQLITE_OMIT_UTF16
static void testHexToUtf16be(sqlite3_context *pCtx, int nArg,
                             sqlite3_value **argv) {
    int n;
    const char *zIn;
    char *zOut;
...
** result using sqlite3_result_text16le().
*/
static void testHexToUtf8(sqlite3_context *pCtx, int nArg,
                          sqlite3_value **argv) {
    int n;
    const char *zIn;
    char *zOut;
...
*/
#ifndef SQLITE_OMIT_UTF16
static void testHexToUtf16le(sqlite3_context *pCtx, int nArg,
                             sqlite3_value **argv) {
    int n;
    const char *zIn;
    char *zOut;
...
*/
static void real2hex(sqlite3_context *context, int argc, sqlite3_value **argv) {
    union {
        sqlite3_uint64 i;
        double r;
        unsigned char x[8];
...
** extract and return.
*/
static void test_extract(sqlite3_context *context, int argc,
                         sqlite3_value **argv) {
...
** in the record.
*/
static void test_decode(sqlite3_context *context, int argc,
                        sqlite3_value **argv) {
    sqlite3 *db = sqlite3_context_db_handle(context);
    u8 *pRec;
    u8 *pEndHdr;   /* Points to one byte past record header */
...
*/
static void test_zeroblob(sqlite3_context *context, int argc,
                          sqlite3_value **argv) {
...
*/
static void test_getsubtype(sqlite3_context *context, int argc,
                            sqlite3_value **argv) {
...
*/
static void test_frombind(sqlite3_context *context, int argc,
                          sqlite3_value **argv) {
    sqlite3_uint64 m = 0;
    int i;
    for (i = 0; i < argc && i < 63; i++) {
        if (sqlite3_value_frombind(argv[i]))
            m |= ((sqlite3_uint64)1) << i;
    }
...
*/
static void test_setsubtype(sqlite3_context *context, int argc,
                            sqlite3_value **argv) {
    sqlite3_result_value(context, argv[0]);
    sqlite3_result_subtype(context, (unsigned int)sqlite3_value_int(argv[1]));
}

static int registerTestFunctions(sqlite3 *db, char **pzErrMsg,
...
** database connection.
*/
static int SQLITE_TCLAPI autoinstall_test_funcs(void *clientData,
...
*/
static int SQLITE_TCLAPI abuse_create_function(void *clientData,
                                               Tcl_Interp *interp, int objc,
                                               Tcl_Obj *CONST objv[]) {
    ...
    rc = sqlite3_create_function(db, "tx", 1, SQLITE_UTF8, 0, tStep, tStep,
                                 tFinal);
    if (rc != SQLITE_MISUSE)
        goto abuse_err;
    ...
    */
    ...
    if (nMatchinfo != (2 + 3 * nCol * nPhrase)) {
        sqlite3_result_error(
            pCtx, "invalid matchinfo blob passed to function rank()", -1);
        return;
    }
    if (nVal != (1 + nCol))
        goto wrong_number_args;
...
static int SQLITE_TCLAPI install_fts3_rank_function(void *clientData,
                                                    Tcl_Interp *interp,
                                                    int objc,
                                                    Tcl_Obj *CONST objv[]) {
    extern int getDbPointer(Tcl_Interp *, const char *, sqlite3 **);
