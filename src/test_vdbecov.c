...
static void test_vdbe_branch(void *pCtx, unsigned int iSrc,
                             unsigned char iBranch, unsigned char iType) {
...
static int SQLITE_TCLAPI test_vdbe_coverage(ClientData cd, Tcl_Interp *interp,
