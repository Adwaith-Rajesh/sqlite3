...
static const u16 azExplainColNames16data[] = {
    ...
    /*  45 */ 'n', 'o', 't', 'u', 's', 'e', 'd', 0,
    /*  53 */ 'd', 'e', 't', 'a', 'i', 'l', 0};
static const u8 iExplainColNames16[] = {0, 5, 12, 15, 18, 21,
                                        24, 27, 35, 38, 45, 53};
...
#error \
    "Must not define both SQLITE_OMIT_DECLTYPE \
...
#ifndef SQLITE_OMIT_UTF16
int sqlite3_bind_text16(sqlite3_stmt *pStmt, int i, const void *zData, int n,
                        void (*xDel)(void *)) {
...
int sqlite3_stmt_scanstatus_v2(
    ...
    int flags, void *pOut /* OUT: Write the answer here */
) {
    Vdbe *p = (Vdbe *)pStmt;
    VdbeOp *aOp;
    int nOp;
...
#ifdef SQLITE_ENABLE_API_ARMOR
    if (p == 0 || pOut == 0 || iScanStatusOp < SQLITE_SCANSTAT_NLOOP ||
