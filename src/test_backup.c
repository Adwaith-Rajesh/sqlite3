...
static int SQLITE_TCLAPI backupTestCmd(ClientData clientData,
...
**
*/
static int SQLITE_TCLAPI backupTestInit(ClientData clientData,
                                        Tcl_Interp *interp, int objc,
                                        Tcl_Obj *const *objv) {
